...
const LEGACY_SHORT_KEYS: ReadonlySet<string> = new Set([
  "html", "css", "scss", "tailwind", "js", "typescript", "react", "next",
  "astro", "seo", "node", "mysql", "mongodb", "firebase", "aws", "gcp",
  "salesforce", "veeva", "jest", "cypress", "git", "gitlab", "github",
  "vercel", "link",
]);
...
const BRAND_COLORS: Record<string, string> = {
  // Languages
  SiJavascript: "#F7DF1E", js: "#F7DF1E",
  SiTypescript: "#3178C6", typescript: "#3178C6",
  SiPython: "#3776AB",
  SiGo: "#00ADD8", SiRust: "#DEA584", SiKotlin: "#7F52FF", SiSwift: "#F05138",
  SiCplusplus: "#00599C", SiC: "#A8B9CC", SiPhp: "#777BB4", SiRuby: "#CC342D",
  SiDart: "#0175C2",
  // Web core
  SiHtml5: "#E34F26", html: "#E34F26",
  SiCss3: "#1572B6", css: "#1572B6",
  SiSass: "#CC6699", scss: "#CC6699",
  SiTailwindcss: "#38BDF8", tailwind: "#38BDF8",
  // Frameworks
  SiReact: "#61DAFB", react: "#61DAFB",
  SiNextdotjs: "#FFFFFF", next: "#FFFFFF",
  SiAstro: "#FF5D01", astro: "#FF5D01",
  SiVuedotjs: "#42B883", SiNuxtdotjs: "#00DC82",
  SiAngular: "#DD0031", SiSvelte: "#FF3E00",
  SiNodedotjs: "#339933", node: "#339933",
  SiExpress: "#FFFFFF", SiNestjs: "#E0234E",
  SiDjango: "#0C4B33", SiFlask: "#FFFFFF", SiFastapi: "#009688",
  SiSpring: "#6DB33F", SiDotnet: "#512BD4", SiRubyonrails: "#D30001",
  // UI libs
  SiMui: "#007FFF", SiMaterialdesign: "#757575",
  SiChakraui: "#319795", SiRadixui: "#FFFFFF", SiShadcnui: "#FFFFFF",
  SiBootstrap: "#7952B3", SiFramer: "#0055FF", SiStorybook: "#FF4785",
  SiThreedotjs: "#FFFFFF", SiD3Dotjs: "#F9A03C",
  SiRedux: "#764ABC",
  // DBs
  SiMysql: "#4479A1", mysql: "#4479A1",
  SiMongodb: "#47A248", mongodb: "#47A248",
  SiPostgresql: "#4169E1", SiRedis: "#FF4438", SiSqlite: "#003B57",
  SiGraphql: "#E10098", SiPrisma: "#2D3748", SiSupabase: "#3ECF8E",
  // Cloud
  SiAmazon: "#FF9900", aws: "#FF9900",
  SiGooglecloud: "#4285F4", gcp: "#4285F4",
  SiFirebase: "#FFCA28", firebase: "#FFCA28",
  SiCloudflare: "#F38020", SiHeroku: "#430098", SiNetlify: "#00C7B7",
  SiDigitalocean: "#0080FF", SiRender: "#46E3B7",
  SiVercel: "#FFFFFF", vercel: "#FFFFFF",
  SiSalesforce: "#00A1E0", salesforce: "#00A1E0",
  SiVeeam: "#64748B", veeva: "#64748B",
  // DevOps / CI
  SiDocker: "#2496ED", SiKubernetes: "#326CE5", SiNginx: "#009639",
  SiTerraform: "#7B42BC", SiAnsible: "#EE0000",
  SiPrometheus: "#E6522C", SiGrafana: "#F46800",
  SiElasticsearch: "#005571", SiKibana: "#E8478B",
  SiApachekafka: "#231F20", SiRabbitmq: "#FF6600",
  SiCircleci: "#343434", SiTravisci: "#3EAAAF", SiJenkins: "#D24939",
  SiGithubactions: "#2088FF",
  // VCS
  SiGit: "#F05032", git: "#F05032",
  SiGithub: "#FFFFFF", github: "#FFFFFF",
  SiGitlab: "#FC6D26", gitlab: "#FC6D26",
  SiBitbucket: "#0052CC",
  // Testing
  SiJest: "#C21325", jest: "#C21325",
  SiCypress: "#69D3A7", cypress: "#69D3A7",
  SiSelenium: "#43B02A", SiVitest: "#6E9F18",
  SiPostman: "#FF6C37", SiInsomnia: "#4000BF", SiSwagger: "#85EA2D",
  // Project mgmt
  SiJira: "#0052CC", SiTrello: "#0079BF", SiConfluence: "#172B4D",
  SiNotion: "#FFFFFF", SiSlack: "#4A154B",
  // Design
  SiFigma: "#F24E1E", SiCanva: "#00C4CC",
  SiAdobephotoshop: "#31A8FF", SiAdobeillustrator: "#FF9A00", SiAdobexd: "#FF61F6",
  // Data / ML
  SiTensorflow: "#FF6F00", SiPytorch: "#EE4C2C",
  SiPandas: "#150458", SiNumpy: "#013243", SiScikitlearn: "#F7931E",
  SiJupyter: "#F37626", SiKaggle: "#20BEFF",
  SiOpencv: "#5C3EE8", SiKeras: "#D00000",
  // Mobile
  SiAndroid: "#3DDC84", SiIos: "#FFFFFF",
  SiFlutter: "#02569B", SiExpo: "#FFFFFF",
  // OS
  SiLinux: "#FCC624", SiUbuntu: "#E95420", SiApple: "#FFFFFF",
  // AI tools
  SiOpenai: "#10A37F", SiAnthropic: "#D97757", SiClaude: "#D97757",
  SiGithubcopilot: "#FFFFFF", SiPerplexity: "#1FB8CD",
  SiHuggingface: "#FFD21E", SiGooglegemini: "#1C69FF",
  SiLangchain: "#1C3C3C",
  // Security / auth
  SiAuth0: "#EB5424",
  // Misc
  SiObsidian: "#7C3AED", SiVeed: "#B5FF44",
  SiStripe: "#635BFF", SiPaypal: "#003087",
  SiTwilio: "#F22F46", SiSendgrid: "#1A82E2",
  SiWebpack: "#8DD6F9", SiVite: "#646CFF", SiBabel: "#F9DC3E",
  SiEslint: "#4B32C3", SiPrettier: "#F7B93E",
};
...
- For each skill item, also set "color" to the brand hex color of that technology (e.g. OpenAI: "#10A37F", JavaScript: "#F7DF1E", TypeScript: "#3178C6", Python: "#3776AB", React: "#61DAFB", Hugging Face: "#FFD21E"). Use null if you genuinely don't know.
    ...
    const skills: Record<Locale, SkillCategory[]> = {
      es: extracted.skills.map<SkillCategory>((c) => ({
        ...
        items: c.items.map((it) => {
          ...
          const color = pickColor(it.color) ?? (icon ? BRAND_COLORS[icon] : undefined);
          return {
            label: it.label,
            ...(icon ? { icon } : {}),
            ...(color ? { color } : {}),
